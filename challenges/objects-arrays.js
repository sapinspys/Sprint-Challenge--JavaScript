...
const tyrannosaurus = {'object name': 'tyrannosaurus', 'diet': 'carnivorous', 'weight': '7000kg', 'length': '12m', 'period': 'Late Cretaceious'};

const stegosaurus = {'object name': 'stegosaurus', 'diet': 'herbivorous', 'weight': '2000kg', 'length': '9m', 'period': 'Late Jurassic'};

const velociraptor = {'object name': 'velociraptor', 'diet': 'carnivorous', 'weight': '15kg', 'length': '1.8m', 'period': 'Late Cretaceious'};
...
const uni = graduates.filter(graduate => graduate.university.includes('University')).map(graduate => graduate.university);
console.log(uni);
...
const populationTotal = zooAnimals.map(animal => animal.population).reduce((total,y) => total+y);
